...
internal struct OperationsServiceClientInterceptorFactory:
        Tinkoff_Public_Invest_Api_Contract_V1_OperationsServiceClientInterceptorFactoryProtocol {
    
    func makeGetOperationsInterceptors() ->
    ...
    func makeGetPortfolioInterceptors() ->
    ...
    func makeGetPositionsInterceptors() ->
    ...
    func makeGetWithdrawLimitsInterceptors() ->
    ...
    func makeGetBrokerReportInterceptors() ->
        [ClientInterceptor<Tinkoff_Public_Invest_Api_Contract_V1_BrokerReportRequest,
            Tinkoff_Public_Invest_Api_Contract_V1_BrokerReportResponse>]
    {
        return []
    }

    func makeGetDividendsForeignIssuerInterceptors() ->
        [ClientInterceptor<Tinkoff_Public_Invest_Api_Contract_V1_GetDividendsForeignIssuerRequest,
            Tinkoff_Public_Invest_Api_Contract_V1_GetDividendsForeignIssuerResponse>]
    {
        return []
    }

    func makeGetOperationsByCursorInterceptors() ->
